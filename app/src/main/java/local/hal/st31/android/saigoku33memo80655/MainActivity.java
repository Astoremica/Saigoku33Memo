...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView listViewTemple=findViewById(R.id.listViewTemple);
        ...
        listViewTemple.setAdapter(adapter);
        listViewTemple.setOnItemClickListener(new ListItemClickListener());
    }
    ...
    private class ListItemClickListener implements AdapterView.OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent,View view, int position,long id){
            ...
            intent.putExtra("selectTempleNo",position);
            intent.putExtra("selectTempleName",templeName);
